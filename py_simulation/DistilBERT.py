...
if __name__ == '__main__':
    ...
    GLUE_TASK_CONFIG = {
        ...
        'cola': {
            'repo' : '2umm3r/distilbert-base-uncased-finetuned-cola',
        ...
        'mrpc': {
            'repo' : 'anirudh21/distilbert-base-uncased-finetuned-mrpc',
            'text_columns': ('sentence1', 'sentence2'),
            'eval_func': 'accuracy',
        },
        'qqp': {
            'repo' : '0xb1/distilbert-base-uncased-finetuned-qqp',
            'text_columns': ('question1', 'question2'),
            'eval_func': 'accuracy',
        },
        'qnli': {
            'repo' : 'anirudh21/distilbert-base-uncased-finetuned-qnli',
            'text_columns': ('question', 'sentence'),
            'eval_func': 'accuracy',
        },
        'rte': {
            'repo' : 'anirudh21/distilbert-base-uncased-finetuned-rte',
            'text_columns': ('sentence1', 'sentence2'),
            'eval_func': 'accuracy',
        },
        'wnli': {
            'repo' : 'anirudh21/distilbert-base-uncased-finetuned-wnli',
            'text_columns': ('sentence1', 'sentence2'),
            'eval_func': 'accuracy',
        },
        ...
        # regression
        'stsb': {
            'repo' : 'vicl/distilbert-base-uncased-finetuned-stsb',
            'text_columns': ('sentence1', 'sentence2'),
